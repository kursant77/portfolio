            ...
            {navItems.map((item) => {
              ...
              return (
                <motion.button
                  ...
                  className={`px-3 py-2 text-[14px] xl:text-[15px] font-black transition-colors duration-300 uppercase tracking-tight relative group whitespace-nowrap ${isActive
                ...
                >
                  ...
                  {isActive && (
                    <motion.div
                      ...
                      className="absolute -bottom-1 inset-x-0 mx-auto h-0.5 bg-blue-500 rounded-full shadow-[0_0_10px_rgba(37,99,235,0.8)] w-2/3"
                      transition={{ type: "spring", bounce: 0.15, duration: 0.5 }}
                    />
                  )}
                  {!isActive && (
                    <span className="absolute -bottom-1 inset-x-0 mx-auto h-0.5 bg-blue-500/50 transition-all duration-300 rounded-full w-0 group-hover:w-2/3" />
                  )}
                </motion.button>
              );
            })}
